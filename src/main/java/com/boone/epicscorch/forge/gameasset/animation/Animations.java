...
public class Animations {
   ...
   private static void buildAnimations(AnimationBuilder builder) {
      ...
      BIPED_HOLD_PISTOL = builder.nextAccessor("biped/living/hold_pistol", (accessor) -> new GunAimAnimation(
         true, accessor, "biped/living/hold_pistol_mid", "biped/living/hold_pistol_up", "biped/living/hold_pistol_down", "biped/living/hold_pistol_up", bipedArmature
      ));
      BIPED_WALK_PISTOL = builder.nextAccessor("biped/living/walk_pistol", (accessor) -> new GunMoveAnimation(
         true, accessor, "biped/living/walk_pistol_mid", "biped/living/hold_pistol_up", "biped/living/hold_pistol_down", "biped/living/hold_pistol_up", bipedArmature
      ));
      BIPED_RUN_PISTOL = builder.nextAccessor("biped/living/run_pistol", (accessor) -> new GunMoveAnimation(
         true, accessor, "biped/living/run_pistol_mid", "biped/living/hold_pistol_up", "biped/living/hold_pistol_down", "biped/living/hold_pistol_up", bipedArmature
      ));
      BIPED_SNEAK_PISTOL = builder.nextAccessor("biped/living/sneak_pistol", (accessor) -> new GunMoveAnimation(
         true, accessor, "biped/living/sneak_pistol_mid", "biped/living/hold_pistol_up", "biped/living/hold_pistol_down", "biped/living/hold_pistol_up", bipedArmature
      ));
      BIPED_PISTOL_AIM = builder.nextAccessor("biped/combat/pistol_aim", (accessor) -> new GunAimAnimation(
         true, accessor, "biped/combat/pistol_aim_mid", "biped/combat/pistol_aim_up", "biped/combat/pistol_aim_down", "biped/combat/pistol_aim_up", bipedArmature
      ));
      BIPED_PISTOL_RELOAD = builder.nextAccessor("biped/combat/pistol_reload", (accessor) -> new LockedAnimation(true, accessor, "biped/combat/pistol_reload", bipedArmature));
      
      BIPED_HOLD_RIFLE = builder.nextAccessor("biped/living/hold_rifle", (accessor) -> new GunAimAnimation(
         true, accessor, "biped/living/hold_rifle_mid", "biped/living/hold_rifle_up", "biped/living/hold_rifle_down", "biped/living/hold_rifle_up", bipedArmature
      ));
      BIPED_WALK_RIFLE = builder.nextAccessor("biped/living/walk_rifle", (accessor) -> new GunMoveAnimation(
         true, accessor, "biped/living/walk_rifle_mid", "biped/living/hold_rifle_up", "biped/living/hold_rifle_down", "biped/living/hold_rifle_up", bipedArmature
      ));
      BIPED_RUN_RIFLE = builder.nextAccessor("biped/living/run_rifle", (accessor) -> new GunMoveAnimation(
         true, accessor, "biped/living/run_rifle_mid", "biped/living/hold_rifle_up", "biped/living/hold_rifle_down", "biped/living/hold_rifle_up", bipedArmature
      ));
      BIPED_SNEAK_RIFLE = builder.nextAccessor("biped/living/sneak_rifle", (accessor) -> new GunMoveAnimation(
         true, accessor, "biped/living/sneak_rifle_mid", "biped/living/hold_rifle_up", "biped/living/hold_rifle_down", "biped/living/hold_rifle_up", bipedArmature
      ));
      BIPED_RIFLE_AIM = builder.nextAccessor("biped/combat/rifle_aim", (accessor) -> new GunAimAnimation(
         true, accessor, "biped/combat/rifle_aim_mid", "biped/combat/rifle_aim_up", "biped/combat/rifle_aim_down", "biped/combat/rifle_aim_up", bipedArmature
      ));
      BIPED_RIFLE_RELOAD = builder.nextAccessor("biped/combat/rifle_reload", (accessor) -> new LockedAnimation(true, accessor, "biped/combat/rifle_reload", bipedArmature));
      
      BIPED_HOLD_BAZOOKA = builder.nextAccessor("biped/living/hold_bazooka", (accessor) -> new GunAimAnimation(
         true, accessor, "biped/living/hold_bazooka_mid", "biped/living/hold_bazooka_up", "biped/living/hold_bazooka_down", "biped/living/hold_bazooka_up", bipedArmature
      ));
      BIPED_WALK_BAZOOKA = builder.nextAccessor("biped/living/walk_bazooka", (accessor) -> new GunMoveAnimation(
         true, accessor, "biped/living/walk_bazooka_mid", "biped/living/hold_bazooka_up", "biped/living/hold_bazooka_down", "biped/living/hold_bazooka_up", bipedArmature
      ));
      BIPED_RUN_BAZOOKA = builder.nextAccessor("biped/living/run_bazooka", (accessor) -> new GunMoveAnimation(
         true, accessor, "biped/living/run_bazooka_mid", "biped/living/hold_bazooka_up", "biped/living/hold_bazooka_down", "biped/living/hold_bazooka_up", bipedArmature
      ));
      BIPED_SNEAK_BAZOOKA = builder.nextAccessor("biped/living/sneak_bazooka", (accessor) -> new GunMoveAnimation(
         true, accessor, "biped/living/sneak_bazooka_mid", "biped/living/hold_bazooka_up", "biped/living/hold_bazooka_down", "biped/living/hold_bazooka_up", bipedArmature
      ));
      BIPED_BAZOOKA_AIM = builder.nextAccessor("biped/combat/bazooka_aim", (accessor) -> new GunAimAnimation(
         true, accessor, "biped/combat/bazooka_aim_mid", "biped/combat/bazooka_aim_up", "biped/combat/bazooka_aim_down", "biped/combat/bazooka_aim_up", bipedArmature
      ));
      BIPED_BAZOOKA_RELOAD = builder.nextAccessor("biped/combat/bazooka_reload", (accessor) -> new LockedAnimation(true, accessor, "biped/combat/bazooka_reload", bipedArmature));
      
      BIPED_HOLD_MINI_GUN = builder.nextAccessor("biped/living/hold_mini_gun", (accessor) -> new GunAimAnimation(
         true, accessor, "biped/living/hold_mini_gun_mid", "biped/living/hold_mini_gun_up", "biped/living/hold_mini_gun_down", "biped/living/hold_mini_gun_up", bipedArmature
      ));
      BIPED_WALK_MINI_GUN = builder.nextAccessor("biped/living/walk_mini_gun", (accessor) -> new GunMoveAnimation(
         true, accessor, "biped/living/walk_mini_gun_mid", "biped/living/hold_mini_gun_up", "biped/living/hold_mini_gun_down", "biped/living/hold_mini_gun_up", bipedArmature
      ));
      BIPED_RUN_MINI_GUN = builder.nextAccessor("biped/living/run_mini_gun", (accessor) -> new GunMoveAnimation(
         true, accessor, "biped/living/run_mini_gun_mid", "biped/living/hold_mini_gun_up", "biped/living/hold_mini_gun_down", "biped/living/hold_mini_gun_up", bipedArmature
      ));
      BIPED_SNEAK_MINI_GUN = builder.nextAccessor("biped/living/sneak_mini_gun", (accessor) -> new GunMoveAnimation(
         true, accessor, "biped/living/sneak_mini_gun_mid", "biped/living/hold_mini_gun_up", "biped/living/hold_mini_gun_down", "biped/living/hold_mini_gun_up", bipedArmature
      ));
      BIPED_MINI_GUN_AIM = builder.nextAccessor("biped/combat/mini_gun_aim", (accessor) -> new GunAimAnimation(
         true, accessor, "biped/combat/mini_gun_aim_mid", "biped/combat/mini_gun_aim_up", "biped/combat/mini_gun_aim_down", "biped/combat/mini_gun_aim_up", bipedArmature
      ));
      BIPED_MINI_GUN_RELOAD = builder.nextAccessor("biped/combat/mini_gun_reload", (accessor) -> new LockedAnimation(true, accessor, "biped/combat/mini_gun_reload", bipedArmature));
      
      BIPED_GRENADE_ARM = builder.nextAccessor("biped/combat/grenade_arm", (accessor) -> new GunAimAnimation(
         false, accessor, "biped/combat/grenade_arm", "biped/combat/grenade_arm", "biped/combat/grenade_arm", "biped/combat/grenade_arm", bipedArmature
      ));
      BIPED_GRENADE_THROW = builder.nextAccessor("biped/combat/grenade_throw", (accessor) -> new ReboundAnimation(
         false, accessor, "biped/combat/grenade_throw", "biped/combat/grenade_throw", "biped/combat/grenade_throw", "biped/combat/grenade_throw", bipedArmature
      ));
   }
}
